...
public class MerchantRegistractionDto implements BaseRegistrationDto{
    // 상인(가게 사장님) 회원가입 요청 바디 DTO
    ...
    @NotBlank(message = "사업자 등록번호는 필수 입력사항입니다.")
    @Pattern(regexp = "^\\d{3}-\\d{2}-\\d{5}$",message = "올바른 사업자 등록 번호 형식이 아닙니다.")
